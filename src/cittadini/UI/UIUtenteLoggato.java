...
public class UIUtenteLoggato extends JFrame implements ActionListener {
    ...
    public UIUtenteLoggato(Cittadino cittadinoLoggato) {
        ...
        ImageIcon imgLogin = new ImageIcon(Objects.requireNonNull(getClass().getResource("/res/login.jpg")));
        ImageIcon imgCentri = new ImageIcon(Objects.requireNonNull(getClass().getResource("/res/centriicon.png")));
        ImageIcon imgEventi = new ImageIcon(Objects.requireNonNull(getClass().getResource("/res/eventiicon.png")));
        ImageIcon imgInfo = new ImageIcon(Objects.requireNonNull(getClass().getResource("/res/userinfo.png")));
